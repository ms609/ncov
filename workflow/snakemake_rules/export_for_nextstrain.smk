...
BUILD_TYPE = 'Preprocessing build' if config.get("upload_preprocessing_files", False) else 'Phylogenetic build'
...
onstart:
    slack_message = f"{BUILD_TYPE} {deploy_origin} started."
...
onerror:
    slack_message = f"{BUILD_TYPE} {deploy_origin} failed."
